...
{
    public class SpellInfoPanelUI : MonoBehaviour
    {
        ...
        public void Setup(SpellData data, RectTransform source)
        {
            float panelW = 300;

            overlayRef = new GameObject("SpellInfoOverlay", typeof(RectTransform), typeof(Image));
            ...
            float contentH = 24 + 2 + 16 + 2 + descLineCount * 16 + 4 + 32 + 12;
            ...
            CreateText("NameText", data.spellName, new Vector2(0, y), new Vector2(260, 22),
                new Vector2(0.5f, 1f), new Vector2(0.5f, 1f), 18, FontStyles.Bold, TextAlignmentOptions.Center, new Color(1f, 0.85f, 0.4f));
            y -= 26;

            CreateText("TypeText", data.spellType.ToString(), new Vector2(0, y), new Vector2(260, 16),
                new Vector2(0.5f, 1f), new Vector2(0.5f, 1f), 12, FontStyles.Bold, TextAlignmentOptions.Center, new Color(0.6f, 0.8f, 1f));
            y -= 18;
            ...
            string statsText = $"Power: {data.power}  |  Radius: {data.radius}";
            CreateText("StatsText", statsText, new Vector2(0, y), new Vector2(260, 16),
                new Vector2(0.5f, 1f), new Vector2(0.5f, 1f), 12, FontStyles.Normal, TextAlignmentOptions.Center, Color.white);
            y -= 18;

            string costText = $"Mana: {data.manaCost}  |  Cooldown: {data.cooldown}s";
            CreateText("CostText", costText, new Vector2(0, y), new Vector2(260, 16),
